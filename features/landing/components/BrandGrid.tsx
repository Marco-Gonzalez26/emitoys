    ...
    <>
      {brands?.map((brand: Brand, index: number) => (
        <Link
          ...
          className={`relative col-span-1 rounded-2xl overflow-hidden border border-border group no-underline box ${index === 0 ? 'min-h-55 md:min-h-55' : 'min-h-40 md:min-h-55'}`}>
          <img
